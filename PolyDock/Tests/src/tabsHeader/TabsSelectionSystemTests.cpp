...
// ---------------------------------------------------------------------------------------------------------
TEST_F(TabsSelectionSystemTest, DontUpdateSelection_WithoutMousePress)
{
	setupHoveredTab();

	sys.update(reg, root);

	EXPECT_FALSE(reg.has<SelectedTabsComponent>(header));
	EXPECT_FALSE(reg.has<DirtyTabsHeaderComponent>(header));
}

// ---------------------------------------------------------------------------------------------------------
TEST_F(TabsSelectionSystemTest, DontUpdateSelection_WithoutHoveredTab)
{
	setupInput();
...
// ---------------------------------------------------------------------------------------------------------
TEST_F(TabsSelectionSystemTest, DontUpdateSelection_WithoutMousePressNorHoveredTab)
{
	sys.update(reg, root);
